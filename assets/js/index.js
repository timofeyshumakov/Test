...
var table_number = 0;
var data = [];
var eye_color_element;
var count_items = 0;
var items_number = 0;
var items_last_number = 0;
var person = [];
...
function myFunction() {
    ...
    fetch('table-data.json')
        ...
        for (items_number = (current_page - 1) * items_on_page; items_number < items_last_number; items_number++) {
            ...
            go[i].innerHTML = "\n            <td class=\"first-name\">".concat(person.name.firstName, "</td>\n            <td class=\"last-name\">").concat(person.name.lastName, "</td>\n            <td class=\"about\">").concat(person.about, "</td>\n            <td class=\"eye-color\">").concat(person.eyeColor, "</td>\n          ");
